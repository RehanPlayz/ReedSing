    ...
    */
     ...
     */
     ...
     async getRank(guildid, userid) {
        let all = await this.db.all().filter(m => m.ID.startsWith(`xp_${guildid}`)).sort((a, b) => b.data - a.data);
     ...
     */
     ...
     async buildRankCard(message, userid, background) {
        ...
        let required = await this.db.get(`requiredxp_${message.guild.id}_${userid}`);
        let bg;
